...
local workspace_offset = 0
for _, monitor in ipairs(monitors) do
	local workspaces_in_monitor = get_workspaces_on_monitor(monitor)
	for k, workspace in ipairs(workspaces_in_monitor) do
	...
	workspace_offset = workspace_offset + #workspaces_in_monitor
end
